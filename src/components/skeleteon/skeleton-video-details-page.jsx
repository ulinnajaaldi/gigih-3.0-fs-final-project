...
const SkeletonVideoDetailsPage = () => {
  return (
    <section className="mb-5 animate-pulse">
      <div className="mt-10 flex flex-col items-start justify-between gap-5 md:flex-row lg:gap-8 xl:gap-10">
        <div className="flex h-[514px] max-h-[514px] w-full flex-auto flex-col gap-2 sm:w-full md:flex-1">
          ...
          <div className="h-8 w-40 bg-gray-400"></div>
        </div>
        <div className="w-full md:w-auto">
          <div className="h-[514px]  w-full overflow-y-auto rounded-md bg-gray-400 md:w-[230px] lg:w-[300px]"></div>
        </div>
      </div>
      <div className="mt-5">
...
export default SkeletonVideoDetailsPage;
